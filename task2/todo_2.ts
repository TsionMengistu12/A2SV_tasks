...
const task = document.getElementById("task") as HTMLInputElement | null;
const taskCon:HTMLUListElement | null = document.querySelector(".task-con");
...
function addTask():void{
    ...
    edit.onclick = () =>{
        if(li.firstChild){
            task.value = (li.firstChild as Text).textContent || "";
        }
